...
|-----------|----------|----------|
| Video analysis | Pidge | Watch stream recordings, extract Charlie timestamps, decode data |
| Blog post writing | Lance | Write posts in Charlie's voice, format Jekyll content |
| Content review | Hunk | Fact-check posts, verify timestamps/embeds, voice consistency |
| Editorial decisions | Keith | Scope posts, prioritize content, approve/reject drafts |
| Pattern tracking | Pidge + Hunk | Cross-reference transmissions, track vocabulary evolution |
| Scope & priorities | Keith | What to cover next, which streams to analyze, editorial direction |
